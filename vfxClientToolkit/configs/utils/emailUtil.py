...
def sendEmailTest(uiInstance):
    ...
    value, status = QtWidgets.QInputDialog.getText(uiInstance, "Input Dialog", "Enter email address:")
    if status:
        ...
        QtWidgets.QMessageBox().information(uiInstance, "Test Email Sent", "Test Email Sent")
